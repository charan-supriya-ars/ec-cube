...
class getShippingMultipleControllerService extends Eccube_KernelInstallContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.xkW3hRa'] ?? $container->load('get_ServiceLocator_XkW3hRaService'))->withContext('Eccube\\Controller\\ShippingMultipleController', $container));
