...
class getChangeControllerService extends Eccube_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.veb.Bum'] ?? $container->load('get_ServiceLocator_Veb_BumService'))->withContext('Eccube\\Controller\\Mypage\\ChangeController', $container));
